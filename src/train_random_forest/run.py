...
def go(args):
    ...
    # 5 - Export the fitted inference pipeline using MLflow model export
    ...
    # 6 - Upload the exported model to W&B
    artifact = wandb.Artifact(
        args.output_artifact,
        type="model_export",
        description="Random Forest inference pipeline exported in the MLflow sklearn format",
        metadata=rf_config,
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # 2 - Preprocessing for non-ordinal categorical features: impute then one-hot encode
    ...
    # 3 - The full inference pipeline: preprocessing followed by the Random Forest
    sk_pipe = Pipeline(
        steps=[
